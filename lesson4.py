...
# Move the rectangle area calculation function from the previous exercise into this module.
# Import the geometry module into your current code and use the function to calculate the area of a rectangle.

#4.3 Exercise

# Create a function that checks if a given string is a palindrome (reads the same forwards and backward).
# The function should take a string as input and return a boolean value (True if it’s a palindrome, False otherwise).
